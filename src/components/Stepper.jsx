export default function Stepper({ steps, activeStepId, onSelectStep }) {
  const activeStepClasses = {
    1: "border-emerald-300 bg-emerald-100 shadow-sm",
    2: "border-amber-300 bg-amber-100 shadow-sm",
    3: "border-sky-300 bg-sky-100 shadow-sm",
    4: "border-violet-300 bg-violet-100 shadow-sm",
    5: "border-rose-300 bg-rose-100 shadow-sm",
  };
